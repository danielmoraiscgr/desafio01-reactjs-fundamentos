...
export function ToDo({ todo, checkedToDo, deleteToDo} : ToDoProps) {
    ...
    return (
        <div className={`${styles.todo} ${todo.checked ? styles.todo_checked : styles.todo_unchecked}`}>
            <button
               className={styles.checkbox}
               onClick={handleCheckToDo}
            >
            <div className={ todo.checked ? styles.radio_checked : styles.radio_unchecked }>
                {
                     todo.checked &&
            ...
            <p className={ todo.checked ? styles.text_checked : styles.text_unchecked }>
                 {todo.text}
      </p>
      <button 
